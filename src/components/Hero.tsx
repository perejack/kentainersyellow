...
import heroImage from "@/assets/heronew.jpeg";
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroImage}
          alt="Kentank Water Storage Solutions"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-primary/40 via-primary/30 to-secondary/20" />
      </div>

      {/* Content */}
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl text-black animate-fade-in">
          ...
          <p className="text-xl md:text-2xl mb-8 text-black/90 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
<a href="https://wa.me/254786006327">Contact Us</a>
            </Button>
          </div>
        </div>
      </div>
