...
import aboutImage from "@/assets/about-kentank.jpg";
          ...
          <div className="space-y-6 animate-fade-in">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
                About <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Kentank</span>
              </h2>
              <div className="w-24 h-1 bg-gradient-primary rounded-full mb-6" />
            </div>
            
            <p className="text-lg text-muted-foreground leading-relaxed">
              Kentank is Kenya's leading manufacturer of premium water storage solutions. 
