          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center">
                <span className="text-secondary-foreground font-bold text-xl">KT</span>
              </div>
              <span className="text-2xl font-bold">Kentank</span>
            </div>
...
<a href="tel:+254736626373" className="text-primary-foreground/80 hover:text-secondary transition-colors">
                  +254736626373
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-secondary flex-shrink-0" />
                <a href="mailto:info@kentank.co.ke" className="text-primary-foreground/80 hover:text-secondary transition-colors">
                  info@kentank.co.ke
                </a>
              </li>
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center text-primary-foreground/60">
          <p>&copy; {new Date().getFullYear()} Kentank. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
